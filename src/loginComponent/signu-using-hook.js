                ...
                <div className='h-2 bg-indigo-400 rounded-t-md'></div>
                  <div className='px-8 py-6'>
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        />
                        {formik.touched.name && formik.errors.name ? <div className=' text-red-600 font-thin'>{formik.errors.name}</div> : null}
                        ...
                        />
                        { formik.touched.email && formik.errors.email ? <div className=' text-red-600 font-thin'>{formik.errors.email}</div> : null}
                        ...
                        />
                        { formik.touched.password && formik.errors.password ? <div className=' text-red-600 font-thin'>{formik.errors.password}</div> : null}
                        ...
                        />
                        {formik.touched.confirmPassword && formik.errors.confirmPassword ? <div className=' text-red-600 font-thin'>{formik.errors.confirmPassword}</div> : null}
